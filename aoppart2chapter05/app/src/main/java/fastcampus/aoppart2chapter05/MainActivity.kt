...
class MainActivity : AppCompatActivity() {
        ...
        addPhotoButton.setOnClickListener {
            when {
                ContextCompat.checkSelfPermission(
                    ...
                    // todo 권한이 잘 부여되었을 때 갤러리에서 사진 선택하는 기능
                    navigatePhotos()
                }
                shouldShowRequestPermissionRationale(permission.READ_EXTERNAL_STORAGE) -> {
                    ...
                    requestPermissions(arrayOf(permission.READ_EXTERNAL_STORAGE), 1000)
                }
            }
        }
    ...
    private fun showPermissionContextPopup() {
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("동의") { _, _ ->     // dialog, which 생략 가능
                requestPermissions(arrayOf(permission.READ_EXTERNAL_STORAGE), 1000)
            }
            .setNegativeButton("취소", { _, _ -> })      // dialog, which 생략 가능
            .create()
            .show()
    }
